...
const Login = () => {
  ...
  const submitdata = () => {
    if (name !== "" && password !== "") {
      axios
        .post("http://localhost:5000/moviecast/login", {
          email: name,
          password: password,
          role: role,
        })
        .then((res) => {
          ...
          if (k !== null) {
            if (k["approved"] === 1) {
              window.localStorage.setItem("role", k["role"]);
              window.localStorage.setItem("i", k["uid"]);
              nav("/yourpost");
            } else {
              alert("Your not approved");
            }
          } else {
            alert("Login Failed");
          }
              ...
              <div class="d-flex justify-content-center text-bg-primary">
                <div class="col-12 col-xl-9">
                  <img
                    ...
                    loading="lazy"
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT9l1W9cBxQgAEA6u8DAn3erMzO-b9ZVolwPA&s"
                    width="245"
                    height="80"
